                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <a href="#"><img src="<?php echo $photo->picture_path();?>" alt="" class="thumbnail" style="width: 100%;"></a>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" rows="10" cols="30" class="form-control"><?php echo $photo->description?></textarea>
                            </div>
                    </div>
                    <div class="col-md-4" >
